...
for bird_file in os.listdir(bird_folder):
    ...
    for pressure_df in pressure_dfs:
        ...
        pressure_df['year'] = pressure_df['year']+1
...
first_line = lst_pressure[2]
plt.hist(first_line, bins=10, edgecolor='black')  # bins=10 pour 10 intervalles
plt.xlabel("Valeurs des coefficients")
plt.ylabel("Fréquence")
plt.title("Histogramme de fréquence des coefficients (3ère pression)")
plt.show()"""
